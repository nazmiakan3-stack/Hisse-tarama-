...
class HealthCheckHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"V10 Full Star Bot Alive!")
...
def calculate_star_rating(change, rsi, pddd, kap_exists):
    """Her hisse için dinamik yıldız derecelendirmesi hesaplar"""
    score = 1
    ...
    if change >= 9.5:
        ...
        score += 2
    elif rsi <= 25:  # Derin Dip
        score += 2

    # PD/DD Defter Değeri Ucuzluk Puanı
